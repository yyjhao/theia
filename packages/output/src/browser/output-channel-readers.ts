...
@injectable()
export class OutputChannelReadersClient implements OutputChannelClient {
    private service: OutputChannelClient;
...
@injectable()
export class OutputChannelReaders implements OutputChannelClient, Disposable {
    ...
    @inject(OutputChannelService) protected remoteChannelService: OutputChannelService;
